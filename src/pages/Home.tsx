        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card>
              ...
              <CardContent>
                <p className="text-gray-600">{t("home.featureAIDetail")}</p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader>
                <div className="flex items-center justify-center bg-green-100 rounded-full w-12 h-12 mb-4">
                  <MdEditDocument className="h-6 w-6 text-green-600" />
                </div>
                <CardTitle>{t("home.featureManual")}</CardTitle>
                <CardDescription>{t("home.featureManualDesc")}</CardDescription>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600">{t("home.featureManualDetail")}</p>
              </CardContent>
            </Card>

            <Card>
              <CardHeader>
                <div className="flex items-center justify-center bg-purple-100 rounded-full w-12 h-12 mb-4">
                  <MdFileUpload className="h-6 w-6 text-purple-600" />
                </div>
                <CardTitle>{t("home.featureOCR")}</CardTitle>
                <CardDescription>{t("home.featureOCRDesc")}</CardDescription>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600">{t("home.featureOCRDetail")}</p>
              </CardContent>
            </Card>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto">
            <div className="relative">
              ...
              <div className="hidden md:block absolute left-[15px] top-0 bottom-0 w-0.5 bg-gray-200 z-0"></div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-600 mb-8">{t("home.readyDesc")}</p>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center gap-8">
            <div className="md:w-1/2">
              ...
              <p className="text-gray-600 mb-6">{t("home.secureDesc")}</p>
            ...
            <div className="md:w-1/2">
              <div className="bg-white p-8 rounded-lg shadow-lg">
                ...
                <ul className="space-y-4">
                  <li className="flex items-start">
                    <div className="flex-shrink-0 flex items-center justify-center w-6 h-6 rounded-full bg-blue-600 text-white text-xs font-bold mr-3 mt-0.5">
                      1
                    </div>
                    <div>
